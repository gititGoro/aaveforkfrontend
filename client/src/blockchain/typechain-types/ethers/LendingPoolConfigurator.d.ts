...
export class LendingPoolConfigurator extends Contract {
  ...
  callStatic: {
     ...
     * refreshes the lending pool core configuration to update the cached address*
     */
    refreshLendingPoolCoreConfiguration(overrides?: Overrides): Promise<void>;
  };
  ...
  populateTransaction: {
    CONFIGURATOR_REVISION(): Promise<PopulatedTransaction>;
    poolAddressesProvider(): Promise<PopulatedTransaction>;
    initialize(_poolAddressesProvider: string): Promise<PopulatedTransaction>;
    initReserve(
      _reserve: string,
      _underlyingAssetDecimals: BigNumberish,
      _interestRateStrategyAddress: string
    ...
    refreshLendingPoolCoreConfiguration(): Promise<PopulatedTransaction>;
  };
}
