...
export interface MockLendingPoolCoreContract
  extends Truffle.Contract<MockLendingPoolCoreInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<MockLendingPoolCoreInstance>;
}
...
export interface ReserveUpdatedFromMock {
...
type AllEvents = ReserveUpdated | ReserveUpdatedFromMock;

export interface MockLendingPoolCoreInstance extends Truffle.ContractInstance {
  CORE_REVISION(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  lendingPoolAddress(txDetails?: Truffle.TransactionDetails): Promise<string>;
  ...
  updateStateOnBorrow: {
    (
      _reserve: string,
      _user: string,
      _amountBorrowed: number | BN | string,
      _borrowFee: number | BN | string,
      _rateMode: number | BN | string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<Truffle.TransactionResponse<AllEvents>>;
    call(
      _reserve: string,
  ...
  updateStateOnSwapRate: {
    (
      _reserve: string,
      _user: string,
      _principalBorrowBalance: number | BN | string,
      _compoundedBorrowBalance: number | BN | string,
      _balanceIncrease: number | BN | string,
      _currentRateMode: number | BN | string,
      txDetails?: Truffle.TransactionDetails
    ): Promise<Truffle.TransactionResponse<AllEvents>>;
    call(
      _reserve: string,
