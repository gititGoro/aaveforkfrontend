...
interface MockLendingPoolCoreInterface extends ethers.utils.Interface {
  functions: {
  ...
  getEvent(nameOrSignatureOrTopic: "ReserveUpdatedFromMock"): EventFragment;
}
...
export class MockLendingPoolCore extends Contract {
  ...
  callStatic: {
     ...
     * @param _reserve the address of the reserve*
     */
    activateReserve(_reserve: string, overrides?: Overrides): Promise<void>;
     ...
     * @param _reserve the address of the reserve*
     */
    deactivateReserve(_reserve: string, overrides?: Overrides): Promise<void>;
     ...
     * @param _reserve the address of the reserve*
     */
    freezeReserve(_reserve: string, overrides?: Overrides): Promise<void>;
     ...
     * updates the lending pool core configuration*
     */
    refreshConfiguration(overrides?: Overrides): Promise<void>;
     ...
     * @param _reserve the address of the reserve*
     */
    unfreezeReserve(_reserve: string, overrides?: Overrides): Promise<void>;
  ...
  estimateGas: {
    CORE_REVISION(): Promise<BigNumber>;
  ...
  populateTransaction: {
    CORE_REVISION(): Promise<PopulatedTransaction>;
    activateReserve(_reserve: string): Promise<PopulatedTransaction>;
    addressesProvider(): Promise<PopulatedTransaction>;
    deactivateReserve(_reserve: string): Promise<PopulatedTransaction>;
    disableBorrowingOnReserve(_reserve: string): Promise<PopulatedTransaction>;
    disableReserveAsCollateral(_reserve: string): Promise<PopulatedTransaction>;
    disableReserveStableBorrowRate(
      _reserve: string
    ...
    freezeReserve(_reserve: string): Promise<PopulatedTransaction>;
    getReserveATokenAddress(_reserve: string): Promise<PopulatedTransaction>;
    getReserveAvailableLiquidity(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReserveConfiguration(_reserve: string): Promise<PopulatedTransaction>;
    getReserveCurrentAverageStableBorrowRate(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReserveCurrentLiquidityRate(
    ...
    getReserveDecimals(_reserve: string): Promise<PopulatedTransaction>;
    getReserveInterestRateStrategyAddress(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReserveIsActive(_reserve: string): Promise<PopulatedTransaction>;
    getReserveIsFreezed(_reserve: string): Promise<PopulatedTransaction>;
    getReserveIsStableBorrowRateEnabled(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReserveLastUpdate(_reserve: string): Promise<PopulatedTransaction>;
    getReserveLiquidationBonus(_reserve: string): Promise<PopulatedTransaction>;
    getReserveLiquidationThreshold(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReserveLiquidityCumulativeIndex(
    ...
    getReserveNormalizedIncome(_reserve: string): Promise<PopulatedTransaction>;
    getReserveTotalBorrows(_reserve: string): Promise<PopulatedTransaction>;
    getReserveTotalBorrowsStable(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    getReserveTotalBorrowsVariable(
    ...
    getReserveTotalLiquidity(_reserve: string): Promise<PopulatedTransaction>;
    getReserveUtilizationRate(_reserve: string): Promise<PopulatedTransaction>;
    getReserveVariableBorrowsCumulativeIndex(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    ...
    isReserveBorrowingEnabled(_reserve: string): Promise<PopulatedTransaction>;
    isReserveUsageAsCollateralEnabled(
      _reserve: string
    ): Promise<PopulatedTransaction>;
    isUserAllowedToBorrowAtStable(
    ...
    refreshConfiguration(): Promise<PopulatedTransaction>;
    removeLastAddedReserve(
      _reserveToRemove: string
    ): Promise<PopulatedTransaction>;
    reservesList(arg0: BigNumberish): Promise<PopulatedTransaction>;
    setReserveBaseLTVasCollateral(
      _reserve: string,
      _ltv: BigNumberish
    ): Promise<PopulatedTransaction>;
    ...
    unfreezeReserve(_reserve: string): Promise<PopulatedTransaction>;
    updateStateOnBorrow(
      _reserve: string,
      _user: string,
      _amountBorrowed: BigNumberish,
