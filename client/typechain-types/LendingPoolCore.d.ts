...
export interface LendingPoolCoreContract
  extends Truffle.Contract<LendingPoolCoreInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<LendingPoolCoreInstance>;
}
...
export interface LendingPoolCoreInstance extends Truffle.ContractInstance {
