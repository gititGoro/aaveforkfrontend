...
export interface LendingPoolInstance extends Truffle.ContractInstance {
  LENDINGPOOL_REVISION(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  dataProvider(txDetails?: Truffle.TransactionDetails): Promise<string>;

  parametersProvider(txDetails?: Truffle.TransactionDetails): Promise<string>;
